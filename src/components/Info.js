    ...
    >
      <Item item="true" xs={1}>
        <Typography style={{ fontSize: 12 }}>
          في آخر يومك تنقر علي (اجمع الذهب) ليحسب لك جميع ما انجزته اليوم و يضاف
          الذهب لجميع العبادات المنجزة إلى رصيدك وتعود المهام بشكل تلقائي لغير
          منجزة لإنجازها من جديد في اليوم التالي وهكذا تستطيع أن تداوم على
          عبادتك وتلتزم فيها بشكل أسهل
        </Typography>
      </Item>
