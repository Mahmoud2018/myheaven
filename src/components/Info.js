    ...
    >
      <Item item xs={1}>
        <Typography style={{ fontSize: 12 }}>
          يتم حساب النقاط لجميع المهام المنجزة في يوميا في 6 صباحا واليوم التالي
          تعود المهام بشكل تلقائي لغير منجزة لإنجازها من جديد وهكذا تستطيع أن
          تداوم على عبادتك وتلتزم فيها بشكل أسهل
        </Typography>
      </Item>
